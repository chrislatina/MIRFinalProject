...
%
\begin{abstract}
Are there new insights through computational methods to the problem of getting song's year? This project, motivated by combining traditional music information retrieval (hereafter referred to as MIR) approach and metadata of song to compute a song's decade.  
\end{abstract}
%
\begin{keywords}
